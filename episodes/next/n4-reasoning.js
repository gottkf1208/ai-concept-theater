...
export default {
  ...
  scenes: [
    ...
    },
    {
      ...
      captions: [
        ...
        { t: 5, text: '이 방식을 Chain-of-Thought(생각의 사슬)라고 불러요. 지금은 이 과정을 <em>아예 안에 넣은</em> 모델들이 나왔어요.' },
    ...
    },
    {
      ...
      captions: [
        { t: 0, text: '<em>"답을 말하기 전에 풀이를 적어 보는 것"</em>과 비슷해요.' },
        { t: 5, text: '확장 사고, 추론 모드처럼 <em>도구마다 부르는 이름이 달라요</em>.' },
      ...
      build({ stage, lines, P, tl }) {
        ...
        const noteTxt = P.text({ x: 400, y: 440, w: 700, text: '이름과 방식이 <em>제각각</em>이에요', size: 22, weight: 700, cls: 'muted' });
  ...
  tip: {
    ...
    extra: '도구별로 이 기능을 부르는 이름이 달라요(확장 사고, 추론 모드 등). 화면에서 이름을 찾기 어려우면 도움말을 검색해 보세요.'
  },
  myth: {
...
다만 시간도 더 걸리고 비용도 더 들어요. 인사말 같은 간단한 질문엔 답은 똑같이 나오면서 느려지기만 할 수 있어요. 난이도를 보고 켤지 말지 정하세요. 학생에겐 "답을 말하기 전에 풀이를 적어 보는 것"에 비유해 주면 좋아요. 도구별로 이름과 방식은 다르니 화면에서 확인해 보세요.`
};

...
export default {
  ...
  title: '같은 프롬프트, 다른 영상',
  subtitle: '확률과 시드',
  summary: '같은 프롬프트를 두 번 넣었는데 영상이 다르게 나온 이유. 시드·잡음·확률·온도로 3분 안에 풀고, 무엇을 기록해야 하는지까지.',
  keywords: ['시드', '확률', '온도', '샘플링', '확산모델', '재현성', '랜덤'],

  scenes: [
    {
      title: '같은 프롬프트, 다른 영상', dur: 13,
      captions: [
        { t: 0, text: '같은 프롬프트를 두 번 넣었더니, 영상이 다르게 나왔어요.' },
        { t: 5, text: '배경도 다르고 움직임도 <em>조금씩 달랐어요</em>.' },
    ...
    },
    {
      ...
      captions: [
        ...
        { t: 5, text: '시드 항목이 아예 없는 도구도 있고, 하드웨어·버전이 달라도 결과가 바뀔 수 있어요.' },
        { t: 9, text: '온도를 0으로 둬도 완전히 똑같지는 않을 수 있어요.' }
      ],
      build({ stage, lines, P, tl }) {
        ...
        const hedges = [
          ['시드가 없는 도구도 있어요', '시드를 못 정하는 영상 도구도 있어요'],
    ...
    },
    {
      title: '할 일', dur: 13,
      captions: [
        { t: 0, text: '<em>설정을 기록</em>해 두고, 두세 번 만들어 보세요.' },
...
마음에 드는 결과가 나오면 프롬프트·시드·모델·비율 같은 설정을 기록해 두고, 두세 번 만들어서 골라 보세요. 다르게 나오는 건 고장이 아니라 확률로 뽑기 때문이에요. 고르는 눈이 우리의 역량이에요.
`
};

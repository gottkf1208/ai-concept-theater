  ...
  scenes: [
    {
      ...
      captions: [
        { t: 0, text: '오늘 연구회에서 문자가 왔어요. <em>"학교에서 쓸 AI 도구, 하나만 정해 주세요."</em>' },
        { t: 5, text: '광고 문구만 보고 고를 순 없잖아요. 뭔가 기준이 있어야겠죠.' },
        { t: 9.5, text: '오늘은 그 기준을 같이 찾아봐요.' }
      ],
    ...
    },
    {
      ...
      captions: [
        ...
        { t: 5, text: '무엇으로 학습했고, 어디에 잘 맞고, 어떤 한계·편향이 있는지 적어 둔 문서예요(Mitchell 외, 2019 제안).' },
    ...
    },
    {
      ...
      captions: [
        { t: 0, text: '그래서 할 일은 간단해요. 체크리스트로 점수를 매겨요.' },

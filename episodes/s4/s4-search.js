...
export default {
  ...
  summary: '지식 마감 때문에 AI가 작년 숫자를 확신에 차 답할 수 있어요. 검색을 켜면 무엇이 달라지고, 그래도 왜 링크를 눌러야 하는지 3분에.',
  ...
  scenes: [
    ...
    },
    {
      ...
      captions: [
        ...
        { t: 9.5, text: '판단 기준은 <em>도구마다 달라요</em>.' }
      ],
      build({ stage, lines, P, tl }) {
        ...
        const note = P.text({ x: 330, y: 560, w: 860, text: '판단 기준은 <em>도구마다 달라요</em>.', size: 28, weight: 800 });
    ...
    },
    {
      ...
      captions: [
        { t: 0, text: '정리할게요. <em>교육청·법령·학교 공문</em>처럼 1차 출처를 우선하세요.' },
        { t: 5, text: '인용 <em>링크를 눌러</em> 원문을 확인하고, <em>날짜</em>를 보세요.' },
        { t: 9.5, text: '학생에게는 이렇게 말해 주세요. "AI가 찾아 준 링크도 <em>눌러서 봐야</em> 진짜 확인이야."' }
      ],
      build({ stage, lines, P, tl }) {
...
그렇다고 늘 검색하는 건 아니에요. 공문·일정·가격처럼 최신·변하는 정보는 검색하고, 수학 개념처럼 안정된 지식은 바로 답해요. 판단 기준은 도구마다 달라요.

검색을 켜도 문제는 남아요. 검색 결과 자체가 광고나 오래된 글, 심지어 잘못된 글일 수 있거든요. 그래서 출처를 볼 때 누가, 언제, 원문(1차)인지를 봐야 해요.

교육청 공문이나 법령처럼 1차 출처를 먼저 확인하고, 인용 링크를 눌러 원문과 날짜를 확인하세요. 학생에게는 이렇게 말해 주세요. "AI가 찾아 준 링크도 눌러서 봐야 진짜 확인이야."
`
};

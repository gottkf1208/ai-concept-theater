...
export default {
  ...
  subtitle: '루브릭과 AI 평가',
  summary: '학생 글 30편을 AI에게 채점시켰더니 같은 글인데 점수가 달랐던 경험, 왜 그런지와 루브릭으로 어떻게 잡는지 3분에.',
  ...
  scenes: [
    ...
    },
    {
      ...
      captions: [
        { t: 0, text: '연구에 따르면 AI 채점엔 특징적인 <em>편향</em>이 있어요(Zheng 외, 2023).' },
    ...
    },
    {
      ...
      captions: [
        ...
        { t: 9.5, text: '학생 이름은 빼고 채점하세요(개인정보는 다음 편에서 더 다뤄요).' }
      ],
      build({ stage, lines, P, tl }) {
...
연구에 따르면 이런 채점에는 특징적인 편향이 있어요. 긴 답을 더 좋게 보는 장황함 편향, 순서에 따라 판정이 달라지는 위치 편향, 자기 문체를 선호하는 편향이에요(Zheng 외, 2023). 그래도 잘 설계하면 사람 평가와 80퍼센트 넘게 일치하기도 해요.

  ...
  scenes: [
    ...
    },
    {
      ...
      captions: [
        ...
        { t: 9.5, text: '한글은 학습 자료가 영어보다 적은 편이고 자모를 조합하는 구조라 더 어렵다고 해요. 도구마다 달라요.' }
      ],
      build({ stage, lines, P, tl }) {
        ...
        const chip = P.chip({ x: 160, y: 578, text: '도구마다 달라요', color: 'gray' });
...
문제는 글자와 손가락이에요. 대략적인 패턴만으로도 나무나 표정은 그럴듯한데, 획순이나 손가락 5개 같은 정확한 구조는 조금만 어긋나도 티가 나요. 한글은 자료가 영어보다 적은 편이고 자모 조합 구조라 더 어렵다고 해요. 도구마다 다르지만요.

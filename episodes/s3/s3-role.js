  ...
  scenes: [
    ...
    },
    {
      ...
      captions: [
        ...
        { t: 5, text: '사람 피드백으로 <em>지시를 따르도록</em> 추가 학습을 시켰어요(InstructGPT, 2022).' },
    ...
    },
    {
      ...
      captions: [
        ...
        { t: 9.5, text: '앱마다 \'지침\'이나 \'맞춤 설정\'처럼 <em>다른 이름</em>으로 불러요.' }
      ],
      build({ stage, lines, P, tl }) {
    ...
    },
    {
      ...
      captions: [
        ...
        { t: 9.5, text: '학생에게는 "질문 앞에 <em>상황을 먼저 말해 주면</em> AI가 더 잘 알아들어"라고 알려 주세요.' }
      ],
      build({ stage, lines, P, tl }) {
...
이렇게 대화 맨 앞에 놓이는 지시문을 시스템 프롬프트라고 불러요. 역할과 독자, 형식, 금지 사항을 적어 두면 이후 모든 답에 영향을 줘요. 앱마다 지침이나 맞춤 설정 같은 이름으로 불러요.

역할만 정해 주고 끝내지 마세요. 독자와 목적, 형식과 제약을 함께 적어 줄 때 효과가 훨씬 커요. 자주 쓰는 지시문은 학급 안내문용, 평가 피드백용처럼 저장해 두면 다음에 편해요.

학생에게는 이렇게 말해 주세요. "질문 앞에 상황을 먼저 말해 주면 AI가 더 잘 알아들어."
`
};

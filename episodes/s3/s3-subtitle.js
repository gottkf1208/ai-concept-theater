...
export default {
  ...
  title: '자막은 왜 가끔 엉뚱할까',
  subtitle: '음성 인식과 번역',
  summary: '브루 자동 자막에서 "사회 시간"이 "사회시장"으로, 친구 이름이 엉뚱한 낱말로 나온 적 있으세요? 소리를 글자로 바꾸는 음성 인식이 왜 가끔 헛짚는지 3분에 담았어요.',
  ...
  scenes: [
    {
      ...
      captions: [
        { t: 0, text: '브루로 만든 학급 영상에 자동 자막을 넣었는데, 이상한 게 있었어요.' },
        { t: 4.5, text: '"사회 시간"이 <em>"사회시장"</em>으로 나왔어요.' },
        { t: 9, text: '친구 이름도 <em>엉뚱한 낱말</em>로 바뀌어 있었어요.' }
      ],
  ...
  interaction: {
    title: '오인식 자막 고치기',
    desc: '브루가 만든 자동 자막 5줄이에요. 이상한 낱말을 눌러 보세요. <b>정답 모두 보기</b>로 한 번에 확인할 수도 있어요.',
    mount(el, P) {
      const LINES = [
  ...
  tip: {
    ...
    extra: '낯선 이름을 미리 단어장으로 등록해 두는 도구도 있어요. 다만 이건 도구마다 달라요.'
  },
  myth: {
  ...
  script: `
브루로 학급 영상을 만들고 자동 자막을 넣었는데, "사회 시간"이 "사회시장"으로 나온 적이 있어요. 친구 이름도 전혀 다른 낱말로 바뀌어 있었고요.

...
export default {
  ...
  scenes: [
    ...
    },
    {
      ...
      build({ stage, lines, P, tl }) {
        ...
        const small = P.text({ x: 330, y: 520, w: 900, text: '2023년 컨트롤넷 연구가 제안한 방식이에요. 조건 종류·강도는 도구마다 달라요.', size: 18, weight: 600, cls: 'muted' });
    ...
    },
    {
      ...
      captions: [
        ...
        { t: 8.5, text: '도구마다 이름은 달라요. <em>구조 참조</em>, <em>포즈 참조</em>, <em>스케치 모드</em>처럼요.' }
      ],
      build({ stage, lines, P, tl }) {
        ...
        const small = P.text({ x: 340, y: 420, w: 850, text: '도구마다 이름은 달라요. <i>구조 참조</i>, <i>포즈 참조</i>, <i>스케치 모드</i>처럼요.', size: 20, weight: 600, cls: 'muted' });
  ...
  tip: {
    ...
    extra: '조건 그림과 프롬프트가 서로 다른 말을 하면(뼈대는 앉았는데 글은 달린다) 이상하게 나와요. 둘을 맞추세요. 이름과 슬라이더는 도구마다 달라요.'
  },
  myth: {
...
조건 그림에는 뼈대 말고도 윤곽선, 깊이, 낙서가 있고 각각 고정하는 게 달라요. 누구는 레퍼런스 이미지, 어디에 어떻게는 조건 그림, 무엇은 프롬프트로 나눠서 주세요. 도구마다 이름은 달라도 원리는 같아요.`
};

  ...
  scenes: [
    ...
    },
    {
      ...
      captions: [
        ...
        { t: 9.5, text: '정확도는 <em>검색이 맞는 조각을 찾았느냐</em>에 달려요. 자료를 어떻게 쪼개고(청크) 어떻게 찾느냐(임베딩 검색)가 핵심이에요.' }
      ],
      build({ stage, lines, P, tl }) {
        ...
        const note = P.text({ x: 380, y: 540, w: 720, text: '정확도는 <em>청크 나누기</em>와 <em>임베딩 검색</em>이 맞는 조각을 찾느냐에 달려요.', size: 26, weight: 700 });
...
NotebookLM 같은 도구가 이런 원리로 자료에 근거해 답해요. 내가 올린 공문이나 교육과정 문서에 근거해 답하고 인용을 달아 줘요. 정확도는 자료를 어떻게 쪼개고(청크) 어떻게 찾느냐(임베딩 검색)에 달려 있어요.

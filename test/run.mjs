...
const SLUGS = (process.env.SLUGS || 'e1-agent-mcp,e2-seed,e3-diffusion,e4-plausible,e5-context,e6-rag,n1-consistency,n2-video-cost,n3-english-prompt,n4-reasoning,n5-vibecoding,n6-ai-label,s3-voice,s3-avatar,s3-music,s3-subtitle,s3-vision,s3-role,s4-grading,s4-sycophancy,s4-privacy,s4-calc,s4-search,s4-choose').split(',');
